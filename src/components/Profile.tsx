...
export const Profile: React.FC<ProfileProps> = ({ showProfileData = true, size = "md" }) => {
  ...
  return (
    <div className={`flex items-center ${gapSize} border-2 border-kudwa-light-blue rounded-3xl p-2 pl-4 select-none`}>
      {showProfileData && (
      ...
      <div className={`flex items-center justify-center bg-kudwa-blue text-white rounded-full ${avatarSize}`}>
